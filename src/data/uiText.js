export const uiTextByLanguage = {
  en: {
    ...
    guides: {
      ...
      desc: 'Task-oriented quick starts: scenario entry → short steps → FAQ → next action, designed for 3-8 minute completion.',
    ...
    blog: {
      ...
      heroDesc: 'Industry trends, product update interpretation, customer stories, expert viewpoints, and launch-event highlights.',
  ...
  zh: {
    ...
    guides: {
      title: 'WPS 操作指南',
      desc: '任务导向的快速上手内容：场景入口 → 步骤 → 常见问题 → 下一步，单篇 3-8 分钟可完成。',
      readGuide: '阅读指南',
      minRead: '分钟阅读',
      backToGuides: '← 返回所有指南',
      tableOfContents: '目录',
    ...
    blog: {
      heroTitle: 'WPS 官方博客',
      heroDesc: '聚焦行业趋势、产品更新解读、客户案例、观点评测与发布会/白皮书等活动内容。',
